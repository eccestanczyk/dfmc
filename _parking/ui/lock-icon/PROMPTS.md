...
# Sites: inventory tile badge (22px, replaces the &#128274; glyph), item-detail LOCK / UNLOCK
# buttons, creature-sheet lock. The two must read as a pair at 22px: same body, shackle closed vs open.

## lock_closed.png — locked
